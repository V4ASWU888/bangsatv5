...
echo "\033[35;1mTeam : black widow"
echo "\033[33;1mKontak Me :  https://wa.me/+6285946352369
echo "\033[31;1mSubcribe Youtube:"
echo "\033[33;1mV4ASWU888" "\033[32;1m&" "\033[36;1mIndonesia Security Lite"
echo "\033[34;1m[============================[>"
sleep 1
echo ""
...
echo "[===============================================]>"
echo "\033[32;1m"
read -p "[root@T00Ls-BANGSATv5:~#" bro
...
then
clear
cowsay -f sheep.cow "KangB4N6AT" | lolcat
figlet "Mr.B4J1N64N" | lolcat
sleep 1
cd
cd module
...
then
clear
cowsay -f kiss.cow "KangB4N64T | lolcat
figlet "Mr.B4J1N64N" | lolcat
sleep 1
cd module
python2 r.py
